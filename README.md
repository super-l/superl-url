...
2021年6月13日: 最新的多个商业版本已经开发与测试完毕！采用GO+java+vue等语言完全重新设计开发。如有需要可加QQ：86717375  群：50246933.

商业版在线文档：https://www.supurl.net/doc


分精准采集与大规模深度采集两个版本。深度采集版本，每日可轻松采集千万级不重复域名！支持国内、国外自定义引擎采集。支持外链采集，支持自定义线程数。
