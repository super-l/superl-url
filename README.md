...
6月13日: 商业旗舰版(独立部署版)已经开发与测试完毕！采用GO+java+vue等语言完全重新设计开发。如有需要可联系QQ:86717375.

注意: 开源的python版本由于在构架与设计上无法完美绕过反爬虫机制，已经放弃更新。部分搜索引擎已经更新了规则，如果采集不到内容，请自行修改。
...
鉴于使用者较多，总是有小伙伴联系我定制二次开发。为了减少二次开发成本，准备使用GO+java+vue重写做出商业版本，方便新手或功能需求更多的用户使用。预计将在6月中旬上线。
